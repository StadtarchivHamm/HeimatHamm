...
namespace ARLocation
{
    ...
    public class Location
    {
        ...
        public const double EarthFirstEccentricitySquared = 6.6943799901414e-3;
        public const double EarthEquatorialRadius = 6371000.79;
        ...
        public Location(Wezit.PoiLocation poiLocation)
        {
            if (poiLocation != null)
            {
                Label = poiLocation.pid;
